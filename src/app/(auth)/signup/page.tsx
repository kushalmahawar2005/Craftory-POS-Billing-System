...
function SignupForm() {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
      ...
      <a href="/api/auth/google" className="w-full h-11 flex items-center justify-center gap-3 bg-white border border-border rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all text-sm font-medium text-text-primary mb-6">
